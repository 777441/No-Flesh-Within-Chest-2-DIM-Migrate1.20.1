...
StartupEvents.registry('item', event => {
    ...
    event.create('kubejs:revolution_gear').maxStackSize(1).texture('kubejs:item/organs/machine/revolution_gear').tag('kubejs:machine')
    event.create('kubejs:jet_propeller').maxStackSize(1).texture('kubejs:item/organs/machine/jet_propeller').tag('kubejs:machine')
    ...
    event.create('kubejs:machine_clockwork').maxStackSize(1).texture('kubejs:item/organs/machine/machine_clockwork').tag('kubejs:machine')
    event.create('kubejs:tamagotchi').maxStackSize(1).texture('kubejs:item/organs/machine/tamagotchi').tag('kubejs:machine')
    event.create('kubejs:energy_bottle_max').maxStackSize(1).texture('kubejs:item/organs/rose_quartz/energy_bottle_max').tag('kubejs:machine')
