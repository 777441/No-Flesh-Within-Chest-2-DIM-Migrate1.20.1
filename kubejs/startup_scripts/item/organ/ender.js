...
StartupEvents.registry('item', event => {
    ...
    event.create('kubejs:dragon_blood_spleen').maxStackSize(1).food(food => food.hunger(2).saturation(1).effect('minecraft:regeneration', 600, 0, 1)).texture('kubejs:item/organs/ender/dragon_blood_spleen').tag('kubejs:dragon').tag('kubejs:ender').tag('kubejs:spleen')
    event.create('kubejs:dragon_blood_appendix').maxStackSize(1).food(food => food.hunger(2).saturation(1).effect('minecraft:regeneration', 600, 0, 1)).texture('kubejs:item/organs/ender/dragon_blood_appendix').tag('kubejs:dragon').tag('kubejs:ender').tag('kubejs:appendix')
