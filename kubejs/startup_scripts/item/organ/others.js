...
StartupEvents.registry('item', event => {
    // 资源
    event.create('kubejs:ore_lung').maxStackSize(1).texture('kubejs:item/organs/resource/ore_lung').tag('kubejs:resource').tag('kubejs:lung')
    event.create('kubejs:desire_of_midas').maxStackSize(1).texture('kubejs:item/organs/resource/desire_of_midas').tag('kubejs:resource')
    event.create('kubejs:redstone_furnace').maxStackSize(1).texture('kubejs:item/organs/resource/redstone_furnace').tag('kubejs:resource').tag('kubejs:heart')
    // 魔法/杂项
    event.create('kubejs:holy_eyeball').maxStackSize(1).texture('kubejs:item/organs/others/holy_eyeball').tag('kubejs:magic').tag('kubejs:muscle')
    ...
    // 感染
    event.create('kubejs:origin_of_tumor').maxStackSize(1).texture('kubejs:item/organs/infected/origin_of_tumor').tag('kubejs:infected')
    // 下界
