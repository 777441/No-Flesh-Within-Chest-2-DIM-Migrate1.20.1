...
StartupEvents.registry('item', event => {
    ...
    event.create('lucky_cookie').texture('kubejs:item/organs/food/lucky_cookie').food(food => {
        food.hunger(1).saturation(1).alwaysEdible().eaten(event => {
            ...
            event.server.runCommandSilent(`/title ${event.player.name.getString()} title {"text":"${Text.translatable(randomGet(luckyCookieSentence)).getString()}"}`)
            if (Math.random() < 0.02) {
    ...
    event.create('candy_canes_wand', 'sword').texture('kubejs:item/candy_canes_wand')
        .maxStackSize(1)
    ...
    event.create('rapier_wand', 'sword').texture('kubejs:item/rapier_wand')
    ...
    event.create('artist_wand', 'sword').texture('kubejs:item/artist_wand')
    ...
    event.create('glass_wand', 'sword').texture('kubejs:item/glass_wand')
        .maxStackSize(1)
