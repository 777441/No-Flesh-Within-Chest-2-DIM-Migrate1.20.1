...
RegistryOrganTooltip(new MultiStateTooltip('kubejs:greedy_stomach')
    .addAlt(Text.translatable('tooltips.kubejs.greedy_stomach.alt.1', Text.gold('30')).gray())
)

RegistryOrganTooltip(new MultiStateTooltip('kubejs:candy_stomach')
    .addDefault(Text.translatable('tooltips.kubejs.candy_stomach.default.1').gray())
    .addDefault(Text.translatable('tooltips.kubejs.candy_stomach.default.2').gray())
    .addAlt(Text.translatable('tooltips.kubejs.candy_stomach.alt.1').gray())
    .addAlt(Text.translatable('tooltips.kubejs.candy_stomach.alt.2').gray())
    .addAlt(Text.translatable('tooltips.kubejs.candy_stomach.alt.3').gray())
    .addAlt(Text.translatable('tooltips.kubejs.candy_stomach.alt.4').gray())
)
