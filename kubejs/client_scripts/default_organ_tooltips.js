...
ItemEvents.tooltip((tooltip) => {
    ...
    registerDefaultOrganToolTips(new DefaultOrgan('kubejs:animal_muscle').addScore('strength', 0.75).addScore('speed', 0.75).build())
    registerDefaultOrganToolTips(new DefaultOrgan('kubejs:fireproof_lung').addScore('breath_recovery', 0.75).addScore('breath_capacity', 0.75).addScore('endurance', 0.75).addScore('fire_resistant', 1).build())
    ...
    registerDefaultOrganToolTips(new DefaultOrgan('kubejs:animal_spleen').addScore('metabolism', 0.75).build())
    ...
    registerDefaultOrganToolTips(new DefaultOrgan('kubejs:fireproof_appendix').addScore('luck', 0.75).addScore('fire_resistant', 1).build())
    ...
    registerDefaultOrganToolTips(new DefaultOrgan('kubejs:fireproof_kidney').addScore('filtration', 0.75).addScore('fire_resistant', 1).build())
    registerDefaultOrganToolTips(new DefaultOrgan('kubejs:fireproof_spleen').addScore('metabolism', 0.75).addScore('fire_resistant', 1).build())
    registerDefaultOrganToolTips(new DefaultOrgan('kubejs:animal_appendix').addScore('luck', 0.75).build())
    registerDefaultOrganToolTips(new DefaultOrgan('kubejs:animal_kidney').addScore('filtration', 0.75).build())
    registerDefaultOrganToolTips(new DefaultOrgan('kubejs:animal_liver').addScore('detoxification', 0.75).build())
    registerDefaultOrganToolTips(new DefaultOrgan('kubejs:animal_rib').addScore('defense', 0.75).build())
    registerDefaultOrganToolTips(new DefaultOrgan('kubejs:fireproof_stomach').addScore('digestion', 0.75).addScore('fire_resistant', 1).build())
    registerDefaultOrganToolTips(new DefaultOrgan('kubejs:fireproof_rib').addScore('defense', 0.75).addScore('fire_resistant', 1).build())
    registerDefaultOrganToolTips(new DefaultOrgan('kubejs:animal_intestine').addScore('nutrition', 0.75).build())
    registerDefaultOrganToolTips(new DefaultOrgan('kubejs:fireproof_heart').addScore('health', 0.75).addScore('fire_resistant', 1).build())
    ...
    registerDefaultOrganToolTips(new DefaultOrgan('kubejs:animal_lung').addScore('breath_recovery', 0.75).addScore('breath_capacity', 0.75).addScore('endurance', 0.75).build())
    ...
    registerDefaultOrganToolTips(new DefaultOrgan('kubejs:animal_stomach').addScore('digestion', 0.75).build())
    registerDefaultOrganToolTips(new DefaultOrgan('kubejs:animal_heart').addScore('health', 0.75).build())
    ...
    registerDefaultOrganToolTips(new DefaultOrgan('kubejs:fireproof_spine').addScore('defense', 0.375).addScore('nerves', 0.75).addScore('fire_resistant', 1).build())
    registerDefaultOrganToolTips(new DefaultOrgan('kubejs:animal_spine').addScore('defense', 0.375).addScore('nerves', 0.75).build())
    registerDefaultOrganToolTips(new DefaultOrgan('kubejs:fireproof_muscle').addScore('strength', 0.75).addScore('speed', 0.75).addScore('fire_resistant', 1).build())
    ...
    registerDefaultOrganToolTips(new DefaultOrgan('kubejs:fireproof_liver').addScore('detoxification', 0.75).addScore('fire_resistant', 1).build())
    ...
    registerDefaultOrganToolTips(new DefaultOrgan('kubejs:fireproof_intestine').addScore('nutrition', 0.75).addScore('fire_resistant', 1).build())
