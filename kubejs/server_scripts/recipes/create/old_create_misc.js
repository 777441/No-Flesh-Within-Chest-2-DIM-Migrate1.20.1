// priority: 800
// 旧版 recipes/create.js 迁移 — Create 机械配方
ServerEvents.recipes(event => {
    ...
    // hamimelon_organ 填充配方已移除（syrup 未注册）
    ...
    // [已移除: chestcavity:golem_cable 不再注册]
    // event.recipes.create.sandpaper_polishing('kubejs:revolution_cable', Ingredient.of('chestcavity:golem_cable'))
    ...
    event.recipes.create.mechanical_crafting('kubejs:revolution_gear', [
        ...
        'SWRWS',
        ' SSS '
    ], { S: 'create:iron_sheet', W: 'createaddition:iron_wire', R: 'createaddition:iron_rod', C: 'minecraft:iron_nugget' })

    event.recipes.create.mechanical_crafting('kubejs:chain_armor_piece', [
        'WSWSW', 'SWSWS', 'WSWSW', 'SWSWS', 'WSWSW'
    ], { S: 'minecraft:iron_nugget', W: 'createaddition:iron_wire' })

    event.recipes.create.mechanical_crafting('kubejs:lamellar_armor_piece', [
        'WSWSW', 'SWSWS', 'WSWSW', 'SWSWS', 'WSWSW'
    ], { S: 'create:iron_sheet', W: 'createaddition:iron_wire' })
    ...
    event.recipes.create.mechanical_crafting('kubejs:energy_bottle_max', [
        ...
        'ABEBA',
        'AAAAA'
    ], { A: 'create:polished_rose_quartz', B: 'createaddition:modular_accumulator', D: 'nameless_trinkets:experience_battery', E: 'minecraft:netherite_ingot' })
    ...
    event.recipes.create.mechanical_crafting('kubejs:aegis', [
        ...
        'DDBBB',
        ' DDDD'
    ], { A: Item.of('goety:iron_hide_focus', '{"Soul Cost":24}'), B: 'graveyard:dark_iron_ingot', C: Item.of('goety:bulwark_focus', '{"Soul Cost":100}'), D: 'create:iron_sheet' })
    ...
    event.recipes.create.mechanical_crafting('kubejs:mace', [
        ...
        '   E   ',
        '   E   ',
    ], { A: 'tetra:forged_bolt', B: 'create:sturdy_sheet', C: 'art_of_forging:forged_steel_ingot', D: 'create:industrial_iron_block', E: 'createaddition:iron_rod' })
    ...
    event.recipes.create.mechanical_crafting('kubejs:machine_clockwork', [
        ...
        '    A A',
        '     A '
    ], { A: 'create:brass_sheet', B: 'createaddition:gold_wire', C: 'goety:animation_core', D: 'createaddition:brass_rod', E: 'create:brass_nugget' })
    ...
    event.recipes.create.mechanical_crafting('kubejs:revolution_bell', [
        ...
        '  D  ',
        '  F  ',
    ], { A: '#forge:plates/brass', B: '#createaddition:spools', C: '#forge:rods/brass', D: 'create:minecart_coupling', E: 'create:clockwork_bearing', F: '#minecraft:anvil' })
    ...
    event.recipes.create.sequenced_assembly([
        ...
        event.recipes.createDeploying('kubejs:incomplete_revolution_delay', ['kubejs:incomplete_revolution_delay', 'minecraft:comparator']),
        event.recipes.createDeploying('kubejs:incomplete_revolution_delay', ['kubejs:incomplete_revolution_delay', 'minecraft:redstone']),
        event.recipes.createDeploying('kubejs:incomplete_revolution_delay', ['kubejs:incomplete_revolution_delay', 'minecraft:redstone_torch']),
    ...
    event.recipes.create.sequenced_assembly([
        ...
        event.recipes.create.filling('kubejs:incomplete_stomach_template', ['kubejs:incomplete_stomach_template', Fluid.of('create:honey').withAmount(500)])
    ...
    event.recipes.create.sequenced_assembly([
        ...
        event.recipes.create.filling('kubejs:incomplete_heart_template', ['kubejs:incomplete_heart_template', Fluid.of('create:honey').withAmount(500)])
    ]).transitionalItem('kubejs:incomplete_heart_template').loops(5)

    // [已移除: chestcavity:blaze_core / active_blaze_rod 不再注册]
    /* event.recipes.create.sequenced_assembly([
    ...
    // [已移除: 与 sequecd_assembly.js 中 furnace_core 配方冲突]
    /* event.recipes.create.sequenced_assembly([
    ...
    // [已移除: chestcavity:gas_bladder 不再注册]
    /* event.recipes.create.sequenced_assembly([
    ...
    event.recipes.create.sequenced_assembly([
        ...
        event.recipes.createDeploying('kubejs:incomplete_glass_wand', ['kubejs:incomplete_glass_wand', 'biomancy:volatile_gland'])
    ...
    event.recipes.create.sequenced_assembly([
        ...
        Item.of('tetra:metal_scrap').withChance(25.0)
    ...
    event.recipes.create.sequenced_assembly([
        ...
        event.recipes.create.filling('minecraft:cookie', ['minecraft:cookie', Fluid.of('minecraft:milk', 500)]),
        event.recipes.createPressing('minecraft:cookie', 'minecraft:cookie'),
        event.recipes.createCutting('minecraft:cookie', 'minecraft:cookie')
    ...
    reg(new RollingRecipe(Item.of('minecraft:tinted_glass'), Item.of('biomancy:vial').withCount(3)))
})
